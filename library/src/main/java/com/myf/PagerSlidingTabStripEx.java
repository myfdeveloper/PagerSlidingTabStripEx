...
import com.myf.pagerslidingtabstripex.R;
...
public class PagerSlidingTabStripEx extends HorizontalScrollView {
    ...
    private int tabCurTextColor = 0xFF666666;
    ...
    public PagerSlidingTabStripEx(Context context, AttributeSet attrs, int defStyle) {
        ...
        tabTextColor = a.getColor(a.getIndex(1),tabTextColor);
        ...
        tabCurTextColor=a.getColor(R.styleable.PagerSlidingTabStrip_pstsTextSelectColor,tabCurTextColor);
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            if (v instanceof TextView) {
                ...
                if (i == selectedPosition)
                    tab.setTextColor(tabCurTextColor);
                else
